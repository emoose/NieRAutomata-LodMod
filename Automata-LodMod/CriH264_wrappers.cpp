...
void criCrw_MemClear(void* a1, void* a2)
{
  ...
  GameAddress<fn_2args>(addr)(a1, a2);
}
...
void criFixedAllocator_Destroy(void* a1)
{ // nullsub
  const uint32_t addr[] = { 0x8640, 0x8640, 0x86B0, 0xC646E8, 0x15154D4 };

  GameAddress<fn_1args>(addr)(a1);
}
...
void* criHeap_Free(void* a1, void* a2)
{
...
void criSj_GetChunk(void* a1, void* a2, void* a3, void* a4)
{
  const uint32_t addr[] = { 0xA2AB4, 0xA2AB4, 0xA2B24, 0xC6EC24, 0x1522E44 };

  GameAddress<fn_4args>(addr)(a1, a2, a3, a4);
}

void* criSj_GetTotalSize(void* a1, void* a2)
{
...
void criSj_PutChunk(void* a1, void* a2, void* a3)
{
...
void criSj_UngetChunk(void* a1, void* a2, void* a3)
{
